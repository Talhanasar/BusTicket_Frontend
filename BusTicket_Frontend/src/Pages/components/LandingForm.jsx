        ...
        <div className='flex flex-col md:flex-row gap-3 w-full text-[0.9rem]'>
            <div className="w-full relative">
                ...
                {showSuggestionsFor === 'from' && suggestions.length > 0 && (
                    <ul className="absolute z-10 w-full bg-white border border-[#1DD10080] rounded-md shadow-lg mt-2 max-h-[10rem] overflow-y-auto" role="listbox">
                        {suggestions.map((suggestion, index) => (
                            <li key={index} role="option">
                                <button
                                    type="button"
                                    className="w-full text-left p-2 cursor-pointer hover:bg-[#1DD10033]"
